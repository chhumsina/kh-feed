<template>
  <div class="comment-section" v-if="postId != ''">
    <div class="modal-header-post" v-if="loadingModal == false">
      ...
      <div v-else>
        <div v-if="showIneedLIst == false" class="btn-save-post">
          <div
            @click="showIneedLIst = true"
            v-if="dataModal.give_status == 'active'"
            style="color: green;"
          >
            <i class="fa fa-smile-o" aria-hidden="true"></i>
            បង្ហាញអ្នកដែលបានសៀវភៅ
          </div>
    ...
    <div v-if="showIneedLIst == true" style="margin-top: 57px;">
      <p
        v-if="ineedListDataLoading == false"
        class="text-center"
      ...
      <p class="text-center" v-if="ineedListDataLoading == true">
        <img :src="loader" />
      </p>
      ...
      <div
        ...
        v-if="ineedListData.length <= 0 && ineedListDataLoading == false"
      >
      ...
      >
        <div
          v-for="(item, $index) in ineedListData"
          :key="$index"
          :data-num="$index + 1"
          class="sina-list-item"
        >
          ...
          <div class="item-text">
            ...
            <div
              v-bind:class="item.accept_status"
              style="float: right; margin-top: -46px; text-align: right"
            >
              <div v-if="item.accept_status == 'selected'">
                <p
                  style="margin-top: 9px; margin-bottom: -8px;color:orangered;"
                >
                  selected
                </p>
                <p
                  style="font-size: 11px; color: rgb(156, 156, 156); margin-top: 9px; margin-bottom: 0;"
                >
                  <timeago
              ...
              <div v-else-if="item.accept_status == 'active'">
                <p style="margin-top: 9px; margin-bottom: -8px;color:green;">
                  accepted
                </p>
                <p
                  style="font-size: 11px; color: rgb(156, 156, 156); margin-top: 9px; margin-bottom: 0;"
          ...
          <div
            style="margin-top: 10px; margin-left: 35px; color: #555;"
            class="font-13"
          >
            {{ item.desc | truncate(20, "...") }}
            <span
          ...
          <div v-if="dataModal.give_status == 'active'">
            <div
              style="margin-top: 10px; text-align: right; color: #555;"
              class="font-13"
            >
              <div
                style="text-align: right; float: right; margin-top: -35px; padding: 4px 8px; color: green;"
                v-if="item.accept_status == 'active'"
              >
                <i class="fa fa-check" aria-hidden="true"></i> selected
                <b>{{ item.name | truncate(10, "...") }}</b>
              </div>
            </div>
          </div>
          <div v-else>
      ...
      <div v-if="ineedListDataLoading == false">
        <div v-if="dataModal.give_status == 'active'">
            <div
              v-if="dataModal.user_id == user.id"
              class="create-comment"
              style="height: 90px; padding-top: 23px; text-align: center;"
            >
              <span style="color:green;">សូមអរគុណចំពោះការបរិច្ចាគសៀវភៅនេះ <br />
              ពួកខ្ញុំបានយកទៅដល់ដៃ​អ្នកដែលត្រូវការហើយ</span>
            </div>
            <div v-else​​ class="create-comment"
              style="height: 90px; padding-top: 23px; text-align: center;">
                <span style="color:green;">សៀវភៅបរិច្ចាគនេះ <br />
          ...
          <div v-else>
            <div
              ...
              style="height: 90px; padding-top: 23px; text-align: center;"
            >
              សូមអរគុណចំពោះការបរិច្ចាគសៀវភៅនេះ <br />
              ពួកខ្ញុំនឹងផ្តល់អោយអ្នកដែលត្រូវការបំផុត
            </div>
            <div
              v-else
              @click="iNeed(dataModal.give_status)"
    ...
    <div v-else>
            ...
            <div class="c_post">
              <div class="box-comments" style="display: block;">
                ...
                <div class="text-center" v-if="numComment == 0">
                  ...
                  ></i>
                  <p
                    style="margin-bottom: -5px; font-weight: bold; color: #aaa;"
                  >
                    មិនទាន់មានមតិទេ
                  </p>
                ...
                <div
                  class="box-comment text-center"
                  v-if="loadingModalComment == true"
                >
                  <p>loading...</p>
                </div>
                <p id="comment"></p>
      ...
      <div class="create-comment">
        <div class="post-modal c_post" v-show="loadingModal == false">
          <div
            style="border: 0;padding-bottom: 10px !important;"
            class="box-footer"
          >
            <form @submit.prevent="createComment">
              <img
                class="img-responsive img-circle img-sm avatar-comment"
          ...
          this.$swal
            .fire({
              ...
              preConfirm: desc => {
                if (desc) {
                  return this.$axios
                    .post("post/i-need", { desc: desc, id: this.postId })
                    .then(function(res) {
                      return res;
                    })
                    .catch(error => {
